...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # Active-button highlight (property-based)
    ...
    # ---------------- UI builders
    def _vesc_group(self, title: str, default_pp="3", default_duty="0.0", default_rpm="0"):
        g = QGroupBox(title)
        l = QVBoxLayout()
    ...
    def _build_manual_tab(self):
        ...
        (self.grp_pump, self.cb_pump, self.lamp_pump, self.lbl_pump_rpm_live, self.pp_pump,
         ...
         self.btn_pump_set_d, self.btn_pump_set_r, self.btn_pump_stop) = self._vesc_group("Pump VESC", default_pp="7",
                                                                                          default_duty="0.07",
                                                                                          default_rpm="2600")
